    ...
    return (
        <div className='container py-2'>
            <form onSubmit={handleSubmit(onSubmit)} className='w-50 mx-auto'>
                ...
                <div className="mb-3">
                    <label htmlFor="exampleInputSkinColor" className="form-label">Skin Color</label>
                    <input placeholder='Skin Color' {...register("skin")} type="text" className="form-control" id="exampleInputSkinColor" />
                </div>
